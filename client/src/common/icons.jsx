...
export const FormatLineSpacingIcon = makeIcon(FormatLineSpacing);
...
export const ShortTextIcon = makeIcon(ShortText);
...
export const VerticalAlignCenterIcon = makeIcon(VerticalAlignCenter);
